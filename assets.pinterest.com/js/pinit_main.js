            ...
            return {
                ...
                btoa: function(a) {
                    ...
                    if (e.w.btoa) b += e.w.btoa(a);
                        ...
                        for (var c, d, f = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", g = 0; a.charAt(0 | g) || (f = "=", g % 1); b += f.charAt(63 & c >> 8 - g % 1 * 8)) d = a.charCodeAt(g += .75), c = c << 8 | d;
                    return b
                },
                ...
                buildStyleSheet: function() {
                    ...
                    }), b = e.v.css, b = b.replace(/\._/g, "." + d.k + "_");
                    var f = {
                ...
                util: {
                    ...
                    navigate: function(a) {
                        ...
                        "forward" === b ? (e.f.changeClass(f[d], {
                            ...
                            future: !0
                        }), d -= 1, d || f[d].className.match("hazVideo") && e.w.setTimeout(function() {
                        ...
                        for (i = 0; i < j.length; i += 1) e.f.changeClass(j[i], {
                            current: i === d
                        });
                ...
                buildOne: function(a, b) {
                    ...
                    if (a && a.length)
                        for (var f = 0; f < a.length; f += 1) e.f.buildOne(a[f], b);
                    else
                        for (var g in a)
                            if ("string" === typeof a[g]) {
                                var h = a[g];
                                if ("text" === g && (b.innerHTML = b.innerHTML + h), "addClass" === g)
                                    for (var i = h.split(" "), f = 0; f < i.length; f += 1) b.className = b.className + " " + e.a.k + "_" + i[f];
                    ...
                    embedGrid: function(a, b) {
                        ...
                        if (a.data) {
                            for (c = a.data, (!b.columns || b.columns < 1 || b.columns > 10) && (b.columns = 5), b.height < 200 && (b.height = 340), s = e.v.config.pinterest + "/" + c.user.profile_url.split("pinterest.com/")[1], d = {
                                ...
                                }, b.noscroll && (d.className = d.className + " noscroll"), b.width && (d.width = b.width + "px"), f = [], g = 0; g < b.columns; g += 1) d.bd.ct.push({
                                col: []
                            }), f[g] = 0;
                            ...
                            var n = function(a) {
                                    for (var b = a || [], c = 0; c < b.length; c += 1)
                                        for (var d = 0; d < b[c].blocks.length; d += 1)
                                            if (b[c].blocks[d].type && b[c].blocks[d].text && "story_pin_heading_block" === b[c].blocks[d].type) return b[c].blocks[d].text;
                                    return null
                                },
                                o = function() {
                                    var a = {
                            ...
                            if (g.story_pin_data && g.story_pin_data.metadata && p[g.story_pin_data.metadata.version]) {
                                ...
                                if (g.story_pin_data.page_count) {
                                    ...
                                    for (c = 0; c < g.story_pin_data.pages.length; c += 1) {
                                        if (h = g.story_pin_data.pages[c], f = {
                                                addClass: "page "
                                            }, (h.style || {}).background_color && (f.backgroundColor = h.style.background_color), canHazPage = !1, "0.7.0" === q.version && h.image_adjusted && h.image_adjusted.images && (canHazPage = !0, f.blocks = {
                                                0: {
                                                    addClass: "block",
                                                    height: "100%",
                                                    width: "100%",
                                        ...
                                        canHazPage && (i.pages["" + t] = f, myProgress = {
                                            addClass: "indicator"
                                        }, t || (myProgress.addClass = myProgress.addClass + " current"), s["" + t] = myProgress, t && (f.addClass = f.addClass + "future "), t += 1)
                                    }
                ...
                build: function(a) {
                    ...
                    for (d = 0, f = c.length; d < f; d += 1)
                        if (g = c[d].href, g && g.match(e.a.myDomain)) {
                ...
                getHere: function() {
                    var a, b = e.d.getElementsByTagName("LINK"),
                        c = "",
                        d = e.d.getElementsByTagName("META"),
                        f = "",
                        g = "",
                        h = function(a) {
                            var b, c, d, f, g = !1,
                                h = "",
                                i = "?",
                                j = a.url.split("#")[0].split("?");
                            if (j[1])
                                for (d = j[1].split("&"), b = 0; b < d.length; b += 1)
                                    if (f = d[b].split("="), 2 === f.length) {
